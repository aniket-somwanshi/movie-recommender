<%-- 
    ...
    Created on : 9 Apr, 2019, 7:07:55 AM
    Author     : Somwanshi
--%>
<%
  ...
  <i class="fa fa-search"></i>
    ...
    <div class="actualnav" style="float: right; display: inline-block; margin-top: 15px;">
        <ul>
            ...
            <a href="SearchByGenre.jsp"><li>Search</li></a>
...
<!--                    <img src="images/wp1851143-the-conjuring-wallpapers.jpg" width="100%" height="700px" alt=""/>-->
                             <div class="centered">
                                 <div class="car-title"><a href="details.jsp?original_title='Interstellar'"><span class="hvr-underline-from-left">INTERSTELLAR</span></a></div>
                                     <span class="car-year">2007</span><div class="circle"></div> <span class="car-year">ACTION, DRAMA, ADVENTURES </span>
                                     <span class="car-subtitle"></span>
...
<div class="containerMain" style="width: 100%;">
    <div class="contentMain" style="margin-left: 100px; margin-right: 100px;">
        <section class="popular">
            ...
            <span class="view">Your Search Results</span>
            ...
            <a href="details.jsp?original_title=<%=rst2.getString("original_title")%>"><img style="margin-right: 8px; margin-bottom: 10px" width="250px" src="https://image.tmdb.org/t/p/w300<%=rst2.getString("poster_path")%>" alt="" /></a>
